...
def run_titanic_analysis(filename):
	...
	logging.info('Start the data analysis pipeline')
	...
	X_train, X_test, y_train, y_test = models.data_preparation(processed_data, test_size=0.2, random_state=0)
